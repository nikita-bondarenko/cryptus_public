...
# Container names
ZDT_BLUE_CONTAINER="cryptus-blue"
ZDT_GREEN_CONTAINER="cryptus-green"
ZDT_MAIN_CONTAINER="cryptus"

# Service names
ZDT_BLUE_SERVICE="cryptus-blue"
ZDT_GREEN_SERVICE="cryptus-green"
ZDT_MAIN_SERVICE="cryptus"
...
ZDT_EXTERNAL_HEALTH_URL="https://cryptus-front-zero-downtime-testing.partners-bot.ru/api/health"
